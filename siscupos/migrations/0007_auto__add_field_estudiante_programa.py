...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Estudiante.programa'
        db.add_column(u'siscupos_estudiante', 'programa',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['siscupos.ProgramaAcademico'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Estudiante.programa'
        db.delete_column(u'siscupos_estudiante', 'programa_id')
    ...
    models = {
        ...
        u'siscupos.estudiante': {
            ...
            'programa': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['siscupos.ProgramaAcademico']", 'null': 'True', 'blank': 'True'})
        },
