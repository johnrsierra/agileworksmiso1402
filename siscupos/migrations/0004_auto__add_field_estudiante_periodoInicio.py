...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Estudiante.periodoInicio'
        db.add_column(u'siscupos_estudiante', 'periodoInicio',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Estudiante.periodoInicio'
        db.delete_column(u'siscupos_estudiante', 'periodoInicio')
