...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Asignatura.nivel'
        db.add_column(u'siscupos_asignatura', 'nivel',
                      self.gf('django.db.models.fields.CharField')(default='Profundizacion', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Asignatura.nivel'
        db.delete_column(u'siscupos_asignatura', 'nivel')
